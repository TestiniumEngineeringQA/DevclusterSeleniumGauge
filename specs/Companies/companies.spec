...
--------------------------------------------
Tags:CompaniesSayfasindanSystemSettingsSayfasinaGecis
...
------------------------
Tags:CompaniesSayfasindanReportsSayfasinaGecis
...
------------------------
Tags:CompaniesSayfasininKontrolleriniYap

* Companies sayfasının elementlerinin kontrollerinin yapılması
* Tablo kontrolünün sağlanması

Test-1-10: Create New Company Form sayfasının kontrollerinin yapılması
------------------------
Tags:CreateNewCompanyFormSayfasininKontrollerininYapilmasi

* Companies sayfasının elementlerinin kontrollerinin yapılması
* Create new company oluşturulması
* Create new company butonuna tıkla

Test-1-11: Companies Form to Edit Page
------------------------
Tags:CompaniesFormToEditPage
...
------------------------
Tags: FillToCompanyForm

* Create new company butonuna tıkla
* Fill company form sayfasının kontrollerinin sağlanması
* "basicInfoTab" elementine tıkla

Test-1-13: Fill to Basic Info Form
------------------------
Tags: FillToBasicInfoForm

* Create new company butonuna tıkla
* Fill company form sayfasının kontrollerinin sağlanması
* Basic Info Sayfasındaki formun doldurulması

Test-1-14: Fill to Version Control System
------------------------
Tags: FillToVersionControlSystem

* Create new company butonuna tıkla
* Version Control System butonuna tıkla
* Version Control sayfasının kontrollerinin sağlanması
* Version Control System sayfasının doldurulması

Test-1-15: Fill to Executor Form
------------------------
Tags: FillToExecutorForm

* Create new company butonuna tıkla
* Executor butonuna tıkla
* Executor sayfasının kontrolllerinin sağlanması

Test-1-16: Fill to Executor Form in Yes
------------------------
Tags: FillToExecutorInYes

* Create new company butonuna tıkla
* Executor butonuna tıkla
* Executor sayfasında external test executor yes butonu
* "ExternalTestExecutor_No" elementine tıkla

Test-1-17: Fill to Plugins Form
------------------------
Tags: FillToPluginsForm

* Create new company butonuna tıkla
* Plugins butonuna tıkla
* Plugins sayfasının kontrolünün sağlanması
* "pluginsCancelButton" elementine tıkla